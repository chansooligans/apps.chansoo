...
def room(request, room_name):
    ...
    if len(remaining_numbers) < 2:
        ...
        RandomNumber.objects.create(value1=number1, value2=number2, room_name=room_name, user_name=user_name)
        context = {"number1": number1, "number2": number2, "room_name":room_name, "user_name":user_name}
